...
<section class="contact">
    ...
    <form action = "adminprocessing" method = "post" enctype="multipart/form-data">
        <div class="form-group">
            <input type="text" name = "namee" class="form-control pt-3 pb-3 mb-3 fs-4" aria-describedby="emailHelp" placeholder="Enter Name in English" required>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
        <input type="file" class="form-control-file pt-3 pb-3 fs-4" id="exampleFormControlFile1">
        </div>
        <button type="submit" name = "add_new_party" class="btn btn-primary w-50 pt-3 pb-3 fs-4" style = "background:#9C53A0;">Add New Party</button>
    </form>
</section>
