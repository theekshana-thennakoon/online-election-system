...
<section class="contact">
	<form action='register' method = 'post'>
        <input type="text" name = 'nic' class="form-control form-control-lg pt-3 pb-3 fs-4" placeholder = "Enter Nic Number" required>
        <input type='submit' name = 'gtotp' value='Confirm identity' class='btn btn-primary btn-lg mt-5 pt-3 pb-3 fs-3' style = 'width:45%;background:#9C53A0;'>
    </form>	
</section>
